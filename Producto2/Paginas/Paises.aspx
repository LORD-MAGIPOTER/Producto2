<%@ Page Title="" Language="C#" MasterPageFile="~/StaticItems.Master" AutoEventWireup="true" CodeBehind="Paises.aspx.cs" Inherits="Producto2.Paginas.Paises" Async="true" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 d-flex justify-content-center align-items-center">
                <h3 class="fw-bold mt-3">Clientes</h3>
            </div>
            <div class="col-sm-12 col-md-12 d-flex justify-content-center align-items-center">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 text-center bg-black border border-1 border-danger">
                <p class="text-light">Seleccione País</p>
